...
plt.plot(x_coords, column_counts, color='white')
...
plt.text(0.1, 0.6, f'Mean: {mean_count:.2f}', fontsize=12, color='white')
plt.text(0.1, 0.4, f'Std Dev: {std_dev:.2f}', fontsize=12, color='white')
plt.text(0.1, 0.2, f'Scale Factor: {scale_factor}', fontsize=12, color='white')
plt.gca().set_facecolor('black')
